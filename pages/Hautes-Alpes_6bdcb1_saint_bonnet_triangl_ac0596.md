...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to What Was Seen at Saint-Bonnet in 1977?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Discusses patterns in sightings and the limits of available evidence, directly relevant to a class C case assessment.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Places unusual sightings within a broader historical and cultural framework, useful context for memorable local reports.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Emphasizes official investigations and witness testimony, paralleling the gendarmerie and GEIPAN aspects of the case.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Examines standards of proof and investigation methods, aligning with the article&#x27;s emphasis on evidential strength.</p>
        <div class="fr-book-actions">
